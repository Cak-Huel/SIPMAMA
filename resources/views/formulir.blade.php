    ...
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form method="POST" action="{{ route('pendaftaran.submit') }}" enctype="multipart/form-data">
            ...
            <fieldset class="mb-8">
                ...
                <div class="space-y-4">
                    <div>
                        <label for="proposal" class="block text-sm font-medium text-gray-700">Upload Proposal</label>
                    ...
                    <div>
                        <label for="rekom" class="block text-sm font-medium text-gray-700">
                            Upload Surat Rekomendasi<span class="text-gray-500">(Opsional jika belum punya)</span></label>
